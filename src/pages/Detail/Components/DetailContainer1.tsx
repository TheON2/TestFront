...
const DetailContainer1 = ({
  ...
  return (
    ...
    >
      ...
      >
        <h1>
          <Badge bg="secondary">{c1}</Badge>
        </h1>
        <h1>
          <Badge bg="secondary">{c2}</Badge>
        </h1>
        <h1>
          <Badge bg="secondary">{c3}</Badge>
        </h1>
        <h1>
          <Badge bg="secondary">{c4}</Badge>
        </h1>
      </div>
      <div
        style={{
      ...
      <div style={{ marginTop: "100px" }}>
        ...
        <h1 style={{ textAlign: "center" }}>
          {title ? title : "대강 맛나보이는 음식이름 "}
        </h1>
        <br />
        <h4 style={{ textAlign: "center" }}>
          {subtitle ? subtitle : "대강 맛있습니다 해먹으십셔"}
        </h4>
      </div>
    </Container2>
  );
