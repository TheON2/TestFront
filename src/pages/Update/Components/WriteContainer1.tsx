...
title,subtitle,url,category1,category2,category3,category4}) => {
    return (
        <Container2
            id="maincontent"
            style={{
        ...
        >
            <Row className="mb-3">
                <Form.Group as={Col} controlId="formGridRecipeName">
                    ...
                    <Form.Control placeholder="" style={{width: "600px"}} onChange={onChangeTitle} value={title}/>
                </Form.Group>
            </Row>
            <Form.Group className="mb-3" controlId="formGridRecipeContent">
                <Form.Label>요리소개</Form.Label>
                <Form.Control placeholder="" style={{width: "600px"}} onChange={onChangeSubtitle} value={subtitle}/>
            </Form.Group>
            <Form.Group className="mb-3" controlId="formGridRecipeUrl">
                <Form.Label>동영상 URL 주소</Form.Label>
                <Form.Control placeholder="" style={{width: "600px"}} onChange={onChangeUrl} value={url}/>
            </Form.Group>
